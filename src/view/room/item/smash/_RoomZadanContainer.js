...
import { EVT_LOGIC_UPDATE_ZADAN_BANNER, EVT_LOGIC_UPDATE_FULL_SERVICE_ZADAN_BANNER } from "../../../../hardcode/HLogicEvent";
import { View, Vibration } from "react-native"
import _RoomZadanItem from "./_RoomZadanItem";
import UserInfoCache from "../../../../cache/UserInfoCache";
export default class _RoomZadanContainer extends PureComponent {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ModelEvent.addEvent(null, EVT_LOGIC_UPDATE_ZADAN_BANNER, this._onData);
        ModelEvent.addEvent(null, EVT_LOGIC_UPDATE_FULL_SERVICE_ZADAN_BANNER, this._onData);
    }

    componentWillUnmount() {
        ModelEvent.removeEvent(null, EVT_LOGIC_UPDATE_ZADAN_BANNER, this._onData);
