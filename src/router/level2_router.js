 ...
 * DiamondGiftDialog
 */
export const showDiamondGiftDialog = () => {
 ...
 * 普通Dailog
 */
export const showNormInfoDialog = (dialogContentText, positiveText, positivePress, negativeText, negativePress) => {
    ...
    require("./ScreensHelper").default.showOverlay(screendId, { dialogContentText, positiveText, positivePress, negativeText, negativePress, }, true);
}

/**
 * 信息Dailog
 */
export const showInfoDialog = (dialogContentText) => {
    ...
    require("./ScreensHelper").default.showOverlay(screendId, { dialogContentText, }, true);
}
