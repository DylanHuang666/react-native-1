...
const server_config = __DEV__
    ...
    : require('./servers/config.xserver7').default
/**
 * appinit.do调用的服务器列表
 * 一个连不上，就用另外一个
 */
...
export const LOGIN_APP_ID = 'lianlianxingqiu';     //登陆时候使用的，服务器用于确认是什么包
export const H5_appPlatform = 'lianlianxingqiu'    //h5传参
// export const H5_appPlatform = 'milu'    //h5传参

//-------------------------------------------------------------------------------------------

export const WECHAT_APPID = "wx68608f89e7f590e2";//微信开发 appId
export const WECHAT_API_SECRET = "ae6eee151db773e1cc72dc1b184c2810";
export const QQ_APP_ID = "1109236638";//QQ开发 appId


const RN_IMG_SERVER = 'http://xvoice-outtest-1301112906.image.myqcloud.com/app/rn/lianlianxingqiu/';   //用来放本地定死的图片，这个跟包吧

const THEME_COLOR = '#00D8C9';   //主题色
