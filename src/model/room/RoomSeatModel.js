 ...
 * 点击主麦位
 */
export const pressMainSeat = () => {
    if (require("./RoomModel").isSelfOnMainSeat()) {
        require("../../router/level3_router").showSeatOpMenuView(true, null);
        return;
    }

    require("../../router/level3_router").showUserCardView(RoomInfoCache.mainMicUserInfo.userId);
 ...
 */
export const pressOtherSeat = (micInfo) => {
    ...
    if (RoomInfoCache.haveRoomPermiss || micInfo.base.userId == UserInfoCache.userId) {
        ...
        require('../../router/level3_router').showUserCardView(micInfo.base.userId)
    }
}