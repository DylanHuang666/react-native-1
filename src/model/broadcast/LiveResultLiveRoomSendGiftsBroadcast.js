...
import { EVT_LOGIC_UPDATE_GIFT_BANNER, EVT_LOGIC_UPDATE_FULL_SERVICE_GIFT_BANNER, EVT_LOGIC_SHOW_FULL_SCREEN_WEBP, EVT_LOGIC_UPDATE_OTHER_PERSON_GIFT_FLY, EVT_LOGIC_GIFT_MY_ROOM } from '../../hardcode/HLogicEvent';
...
export default async function (evName, data) {
    ...
    for (const receiverInfo of data.receiverInfos) {
        const res = await require("../ServerCmd").MyCmd_getUserInfoList({
            ...
            type: EUserDataType.LOGOTIME + EUserDataType.ThirdIconurl,
        });
